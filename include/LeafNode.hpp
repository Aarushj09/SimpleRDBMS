...
public:
    ...
    void left_redistribute(TreeNode *sibling_node) override;
    void right_redistribute(TreeNode *sibling_node) override;
    void merge_nodes(TreeNode *sibling_node) override;

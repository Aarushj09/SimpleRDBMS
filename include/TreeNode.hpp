...
public:
    ...
    virtual void left_redistribute(TreeNode* sibling_node) {}
    virtual void right_redistribute(TreeNode* sibling_node) {}
    virtual void merge_nodes(TreeNode* sibling_node) {}
